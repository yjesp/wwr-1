...
<body>
  ...
  <main>
    ...
    <h2>Overview</h2>
    <h3>Purpose</h3>
    <p>[This website is designed to provide good information for rafting. Every people
    can click easily and approach this website. You can get useful information through
    this website]</p>
    <!-- change this -->

    <h3>Audience</h3>
    <p>[The people who want to relax from hard work, enjoy group meeting, and make 
    bond with good human can use our website. The only thing you do is just click,
    then our website automatically guide you good site.
    </p>
    <!-- change this -->
